...
checklists <-
  map(checklist_keys, function(x) datasets(uuid = x)) %>%
...
3. Remove `accessed via GBIF.org on yyyy-mm-dd.` from citation (we want the static citation of the dataset).
...
4. Save to [CSV](https://github.com/trias-project/unified-checklist/blob/master/data/raw/checklists.csv).
