...
subtitle: "For: National, unified checklist of alien species in Belgium"
author:
- Lien Reyserhove
- Peter Desmet
- Damiano Oldoni
...
Have lowercase column names:

```{r}
taxon %<>% clean_names()       
```

3. Separate `input_canonical_name` in 3 parts:

```{r}
taxon %<>% separate(
  input_canonical_name,
  into = c(
    "input_canonical_name_genus",
    "input_canonical_name_species",
    "input_canonical_name_infraspecific"
  ),
  sep = "\\s+",
  remove = FALSE,
  convert = TRUE,
