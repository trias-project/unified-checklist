...
The license of the unified checklist equals the least open license of the source checklists. In the TrIAS project, the checklists can be published under the following licenses, ranked from most open (1) to most restricive (3):
...
We add the ranking to these licenses and extract the most restrictive one by its highest ranking:
