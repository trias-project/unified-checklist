...
```{r}
taxa <- read_csv(here("data", "interim", "taxa.csv"))
```
...
```{r}
write_csv(distributions, here("data", "interim", "distributions.csv"), na = "")
```
...
```{r}
write_csv(speciesprofiles, here("data", "interim", "speciesprofiles.csv"), na = "")
```
...
```{r}
write_csv(descriptions, here("data", "interim", "descriptions.csv"), na = "")
```
