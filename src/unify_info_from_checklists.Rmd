...
write_tsv(taxa_verified, 
          path = "../data/interim/unified_checklist_taxon_full.tsv")
```
...
write_tsv(distribution, 
                 path = "../data/interim/unified_checklist_distribution_not_standardized.tsv")
```
...
write_tsv(native_range_df, 
                 path = "../data/interim/unified_checklist_native_range_not_standardized.tsv")
```
...
write_tsv(pathways_df, 
                 path = "../data/interim/unified_checklist_pathways_not_standardized.tsv")
```
...
write_tsv(invasion_stages_df, 
                 path = "../data/interim/unified_checklist_invasion_stage_not_standardized.tsv")
```
...
write_tsv(species_profiles, 
                 path = "../data/interim/unified_checklist_species_profile_not_standardized.tsv")
```
