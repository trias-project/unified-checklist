...
2. Assign checklist order (= index of checklist keys) as extra column to taxa.
...
5. Save to [CSV](https://github.com/trias-project/unified-checklist/blob/master/data/unified/distributions.csv).
...
4. Save to [CSV](https://github.com/trias-project/unified-checklist/blob/master/data/unified/speciesprofiles.csv).
...
4. Save to [CSV](https://github.com/trias-project/unified-checklist/blob/master/data/unified/descriptions.csv).
