...
```{r}
speciesprofile_unified <- speciesprofile %>%
...
```{r}
speciesprofile_unified <- speciesprofile_unified %>%
...
```{r}
write_csv(speciesprofile_unified, here("data", "test", "output", "speciesprofile_unified.csv"), na = "")
```
...
```{r}
descriptions_unified <- description %>%
