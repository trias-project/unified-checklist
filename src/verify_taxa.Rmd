...
```{r verify_taxa-2}
verification <- read_tsv(here("data", "interim", "verification.tsv"))
```
...
3. Save updated verification back to [`data/interim/verification.tsv`](https://github.com/trias-project/unified-checklist/blob/master/data/interim/verification.tsv) (sorted on `scientificName`)

```{r verify_taxa-4}
verification$verification %>%
  arrange(scientificName) %>%
  write_tsv(here("data", "interim", "verification.tsv"), na = "")
```
